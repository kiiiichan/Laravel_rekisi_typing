...
window.onload = function(){
  ...
  async function imagePreLoad() {
      ...
      await loadImage('../image/03.png');
      await loadImage('../image/04.png');
      await loadImage('../image/05.png');
      await loadImage('../image/06.jpg');
      await loadImage('../image/07.png');
      await loadImage('../image/08.png');
      await loadImage('../image/09.png');
      await loadImage('../image/10.png');
      await loadImage('../image/11.png');
      await loadImage('../image/12.jpg');
      await loadImage('../image/13.png');
      await loadImage('../image/14.png');
      await loadImage('../image/15.jpg');
      await loadImage('../image/16.jpg');
...
//関数６．判定処理  
 ...
 // let input = player_type.value;
  ...
  function start(){
    ...
    getPid();
    itemShuffle(items);
    initDisplay(TIME);//スタートボタン押下時にもinitGame
  }
